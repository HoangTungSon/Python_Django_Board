...
class BoardTopicsTests(TestCase):
    def setUp(self):
        Boards.objects.create(name='Django', description='Django board test case.')
...
class HomeTests(TestCase):
    def setUp(self):
        self.board = Boards.objects.create(name='Django', description='Django board.')
        url = reverse('home')
...
class NewTopicTests(TestCase):
    def setUp(self):
        Boards.objects.create(name='Django', description='Django board.')
    ...
    def test_contains_form(self):  # <- new test
        ...
        self.assertIsInstance(form, NewTopicFrom)
